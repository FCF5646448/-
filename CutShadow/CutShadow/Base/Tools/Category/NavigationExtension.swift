...
extension UINavigationController {
    func setAppearance() {
        ...
        navigationBar.tintColor = UIColor.hex(textColor) //这个是设置返回按钮颜色
        navigationBar.titleTextAttributes = [NSAttributedString.Key.foregroundColor:UIColor.hex(textColor),NSAttributedString.Key.font:UIFont.systemFont(ofSize: 18)] // 这个是设置title颜色
    ...
    func setTabBar(_ normalImgName:String,_ selectImgName:String, _ normalTitleColor:UIColor = UIColor.lightGray,_ selectTitleColor:UIColor = UIColor.white, title:String = "" ) {
